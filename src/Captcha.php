 ...
 * 图形验证码
 *
 * copy wangyongqiang  https://github.com/stivenjoe8/apicaptcha
 *
 * User: Chris Xu
 * Date: 2019/6/28 20:45
 */

namespace Sevenrich\Apicaptcha;

class Captcha
{
    protected $config =	array(
        'seKey'     =>  'sevenrich.apicaptcha',   // 验证码加密密钥
        'codeSet'   =>  '2345678abcdefhjkmnpqrstuvwxyzABCDEFGHJKMNPQRTUVWXY',             // 验证码字符集合
